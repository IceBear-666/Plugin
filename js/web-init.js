...
function(a, b, c, d, e, f) {
    ...
    function h() {
       if(window.jm_jminer.isLock == "true"){
        ...
        function(event) {
            new f('#jm_homebar', 'left:-325px', 0.1, 'easeOut').run(); 
             $("#jm_homebar #jm_hblogin #jm_hbtrigger").attr("class","arrow-right");
             if(KISSY.one('#jm_homebar').css('left') == '-325px'){
                new f('#jm_homebar', 'left: 0; ', 0.1, 'easeOut').run(); 
    ...
    var processCodeBaseData = function(data) {
        ...
        if(data.content && data.content.edu_list[0]){
            ...
            for(var i = eList.length-1; i >= 0 ; i--){
             //   html += '<div class="infopledu">  <div class="mt-title"><div class="metil mt10">教育经历' + (ordering+1) + '</div><div class="mt-edit"><i></i>编辑</div></div>  <div class="infopl" data-id="' + eList[i].id + '"> <table width="100%" border="0" cellspacing="0" cellpadding="0"> <tbody><tr> <td width="76" class="col999">学校</td> <td class="mt_base" id="mt_schoolName">' + eList[i].schoolName + '</td> </tr> <tr> <td width="76" class="col999">学校所在城市-省</td> <td class="mt_base" id="mt_schoolcity">' + eList[i].school_city + '</td> </tr><tr><td width="76" class="col999">学校所在城市-市</td> <td class="mt_base" id="mt_schoolcity_city">' + eList[i].school_city_city + '</td> </tr>  <tr> <td width="76" class="col999">学历</td> <td class="mt_base" id="mt_education">' + eList[i].education + '</td> </tr>  <tr> <td width="76" class="col999">学位</td> <td class="mt_base" id="mt_degree">' + eList[i].degree + '</td> </tr>  <tr> <td width="76" class="col999">院系</td> <td class="mt_base" id="mt_academy">' + eList[i].academy + '</td> </tr> <tr> <td width="76" class="col999">专业</td> <td class="mt_base" id="mt_professional">' + eList[i].professional + '</td> </tr><tr> <td width="76" class="col999">入学时间</td> <td class="mt_base" id="mt_startYear">' + eList[i].startYear.split('-')[0]+'.'+eList[i].startYear.split('-')[1] + '</td> </tr><tr> <td width="76" class="col999">毕业时间</td> <td class="mt_base" id="mt_endYear">' + eList[i].endYear.split('-')[0]+'.'+ eList[i].endYear.split('-')[1] + '</td> </tr><tr> <td width="76" class="col999">主修课程</td> <td class="mt_base" id="mt_major">' + eList[i].major + '</td> </tr> <tr> <td width="76" class="col999">GPA(4分制)</td> <td class="mt_base" id="mt_gpascore">' + eList[i].gpa_score + '</td> </tr><tr> <td width="76" class="col999">所在专业排名</td> <td class="mt_base" id="mt_professionalranking">' + eList[i].professional_ranking + '</td> </tr><tr> <td width="76" class="col999">班级排名</td> <td class="mt_base" id="mt_classranking">' + eList[i].class_ranking + '</td> </tr><tr> <td width="76" class="col999">专业描述</td> <td class="mt_base" id="mt_professionaldes">' + eList[i].professional_describe + '</td> </tr><tr> <td width="76" class="col999">导师姓名</td> <td class="mt_base" id="mt_tutorname">' + eList[i].tutor_name + '</td> </tr><tr> <td width="76" class="col999">导师联系方式</td> <td class="mt_base" id="mt_tutorphone">' + eList[i].tutor_phone + '</td> </tr></tbody> </table> </div>';
        ...
        if(data.content && data.content.exp_list[0]){
            ...
            for(var i = eList.length-1; i >= 0 ; i--){
               // html += '<div class="infopledu"> <div class="mt-title"> <div class="metil mt10">工作经历' + (ordering+1) + '</div> <div class="mt-edit"><i></i>编辑</div> </div> <div class="infopl" data-id="' + eList[i].id + '"> <table width="100%" border="0" cellspacing="0" cellpadding="0"> <tbody> <tr> <td width="76" class="col999">公司</td> <td class="mt_base" id="mt_companyName">' + eList[i].companyName + '</td> </tr> <tr> <td width="76" class="col999">职位</td> <td class="mt_base" id="mt_positionName">' + eList[i].positionName + '</td> </tr> <tr> <td width="76" class="col999">在职时间</td> <td class="mt_base" id="mt_comtime">' + eList[i].startDate + '-' + eList[i].endDate + '</td> </tr> <tr> <td width="76" class="col999">工作内容</td></tr><tr> <td class="mt_base" id="mt_workContent"> <pre rows="8" cols="40">' + eList[i].workContent + '</pre> </td> </tr> </tbody> </table> </div>';
                 html += '<div class="infopledu"> <div class="mt-title"> <div class="metil mt10">工作经历' + (ordering+1) + '</div><div class="mt-edit"><i></i>编辑</div> </div> <div class="infopl" data-id="' + eList[i].id + '"> <table width="100%" border="0" cellspacing="0" cellpadding="0"> <tbody> <tr> <td width="76" class="col999">工作单位</td> <td class="mt_base" id="mt_companyName">' + eList[i].companyName + '</td> </tr> <tr> <td width="76" class="col999">工作性质</td> <td class="mt_base" id="mt_workcat">' + eList[i].work_cat + '</td> </tr> <tr> <td width="76" class="col999">单位性质</td> <td class="mt_base" id="mt_companyproperty">' + eList[i].company_property + '</td> </tr> <tr> <td width="76" class="col999">公司规模</td> <td class="mt_base" id="mt_companySize">' + eList[i].company_size + '</td> </tr> <tr> <td width="76" class="col999">行业类别</td> <td class="mt_base" id="mt_companyCat">' + eList[i].company_cat + '</td> </tr> <tr> <td width="76" class="col999">工作职位</td> <td class="mt_base" id="mt_positionName">' + eList[i].positionName + '</td> </tr> <tr> <td width="76" class="col999">所在部门</td> <td class="mt_base" id="mt_department">' + eList[i].department + '</td> </tr> <tr> <td width="76" class="col999">工作城市</td> <td class="mt_base" id="mt_workCity">' + eList[i].work_city + '</td> </tr> <tr> <td width="76" class="col999">职责描述</td></tr><tr> <td class="mt_base" id="mt_workContent"> <pre rows="8" cols="40">' + eList[i].workContent + '</pre> </td> </tr> <tr> <td width="76" class="col999">职位月薪(税前)</td> <td class="mt_base" id="mt_salaryMonth">' + eList[i].salary_month + '</td> </tr> <tr> <td width="76" class="col999">所在部门</td> <td class="mt_base" id="mt_companyName">' + eList[i].companyName + '</td> </tr> <tr> <td width="76" class="col999">在职时间</td> <td class="mt_base" id="mt_startDate">' + eList[i].startDate + '</td> </tr> <tr> <td width="76" class="col999">在职时间</td> <td class="mt_base" id="mt_startDatedot">' + eList[i].startDate.split('-')[0]+'.'+ eList[i].startDate.split('-')[1] + '</td> </tr> <tr> <td width="76" class="col999">离职时间</td> <td class="mt_base" id="mt_endDate">' + eList[i].endDate + '</td> </tr> <tr> <td width="76" class="col999">离职时间</td> <td class="mt_base" id="mt_endDatedot">' + eList[i].endDate.split('-')[0]+'.'+ eList[i].endDate.split('-')[1] + '</td> </tr> <tr> <td width="76" class="col999">在职时间</td> <td class="mt_base" id="mt_startDateDashes">' + eList[i].startDate.split('-')[0]+'-'+ eList[i].startDate.split('-')[1] + '</td> </tr><tr> <td width="76" class="col999">离职时间</td> <td class="mt_base" id="mt_endDateDashes">' + eList[i].endDate.split('-')[0]+'-'+ eList[i].endDate.split('-')[1] + '</td> </tr>  <tr> <td width="76" class="col999">工作内容</td></tr><tr> <td class="mt_base" id="mt_workContent"> <pre rows="8" cols="40">' + eList[i].jobContent + '</pre> </td> </tr> <tr> <td width="76" class="col999">离职原因</td> <td class="mt_base" id="mt_reasons">' + eList[i].reasons + '</td> </tr> <tr> <td width="76" class="col999">证明人姓名</td> <td class="mt_base" id="mt_reterenceName">' + eList[i].reterence_name + '</td> </tr> <tr> <td width="76" class="col999">证明人关系</td> <td class="mt_base" id="mt_reterenceRelation">' + eList[i].reterence_relation + '</td> </tr> <tr> <td width="76" class="col999">证明人单位</td> <td class="mt_base" id="mt_reterenceCompany">' + eList[i].reterence_company + '</td> </tr> <tr> <td width="76" class="col999">证明人职位</td> <td class="mt_base" id="mt_reterencePosition">' + eList[i].reterence_position + '</td> </tr> <tr> <td width="76" class="col999">证明人联系方式</td> <td class="mt_base" id="mt_reterence_phone">' + eList[i].reterence_phone + '</td> </tr> <tr> <td width="76" class="col999">工作经历</td></tr><tr> <td class="mt_base" > <pre rows="8" cols="40" id="mt_workList">'+'公司名：'+eList[i].companyName +'  开始时间：'+eList[i].startDate+'  结束时间：'+eList[i].endDate+'  职位：'+eList[i].positionName+'  所在部门：'+eList[i].department+'  工作内容：'+ eList[i].workContent + '</pre> </td> </tr>';
...
KISSY.add('jmPopSchClub', function(S, Node, Base, IO) {
    ...
    var processCodeBaseData = function(data) {
        ...
        if(data.content && data.content.schoolclub_list[0]){
            ...
            var ordering = 0;
            for(var i = eList.length-1; i >= 0 ; i--){
                html += '<div class="infopledu">  <div class="mt-title"><div class="metil mt10">社团经历' + (ordering+1) + '</div><div class="mt-edit"><i></i>编辑</div></div>  <div class="infopl" data-id="' + eList[i].id + '"> <table width="100%" border="0" cellspacing="0" cellpadding="0"> <tbody><tr> <td width="76" class="col999">社团名称</td> <td class="mt_base" id="mt_schClubName">' + eList[i].schClubName + '</td> </tr> <tr> <td width="76" class="col999">社团等级</td> <td class="mt_base" id="mt_schClubLevel">' + eList[i].schClubLevel + '</td> </tr> <tr> <td width="76" class="col999">担任职务</td> <td class="mt_base" id="mt_positionName">' + eList[i].positionName + '</td> </tr> <tr> <td width="76" class="col999">工作职责</td> <td class="mt_base" id="mt_workDes">' + eList[i].workDes + '</td> </tr> <tr> <td width="76" class="col999">开始时间</td> <td class="mt_base" id="mt_startDate">' + eList[i].startDate + '</td> </tr> <tr> <td width="76" class="col999">结束时间</td> <td class="mt_base" id="mt_endDate">' + eList[i].endDate + '</td> </tr> <tr> <td width="76" class="col999">社团经历</td> <td class="mt_base" id="mt_schClubList"> 社团名称：' + eList[i].schClubName + '担任职务：'+ eList[i].positionName + '时间：'+ eList[i].startDate +'-'+ eList[i].startDate + '</td> </tr> </tbody> </table> </div>';
...
KISSY.add('jmPopSchAwards', function(S, Node, Base, IO) {
    ...
    var processCodeBaseData = function(data) {
        ...
        if(data.content && data.content.schoolawards_list[0]){
            ...
            var ordering = 0;
            for(var i = eList.length-1; i >= 0 ; i--){
                html += '<div class="infopledu">  <div class="mt-title"><div class="metil mt10">获奖经历' + (ordering+1) + '</div><div class="mt-edit"><i></i>编辑</div></div>  <div class="infopl" data-id="' + eList[i].id + '"> <table width="100%" border="0" cellspacing="0" cellpadding="0"> <tbody><tr> <td width="76" class="col999">获奖名称</td> <td class="mt_base" id="mt_awardsName">' + eList[i].awardsName + '</td> </tr> <tr> <td width="76" class="col999">获奖类型</td> <td class="mt_base" id="mt_awardsType">' + eList[i].awardsType + '</td> </tr> <tr> <td width="76" class="col999">担任职务</td> <td class="mt_base" id="mt_awardsLevel">' + eList[i].awardsLevel + '</td> </tr> <tr> <td width="76" class="col999">获奖时间</td> <td class="mt_base" id="mt_awardsDate">' + eList[i].awardsDate + '</td> </tr> <tr> <td width="76" class="col999">获奖时间年月</td> <td class="mt_base" id="mt_awardsDatedot">' + eList[i].awardsDate.split('-')[0]+"."+eList[i].awardsDate.split('-')[1] + '</td> </tr> <tr> <td width="76" class="col999">获奖描述</td> <td class="mt_base" id="mt_awardsDes">' + eList[i].awardsDes + '</td> </tr><tr> <td width="76" class="col999">获奖经历</td></tr><tr> <td class="mt_base" > <pre rows="8" cols="40" id="mt_schawradList">'+'获奖名称：'+eList[i].awardsName +'  获奖时间：'+eList[i].awardsDate+'  获奖类型：'+eList[i].awardsType+'  获奖描述：'+eList[i].awardsDes + '</pre> </td> </tr> </tbody> </table> </div>';
...
KISSY.add('jmPopCertificate', function(S, Node, Base, IO) {
    ...
    var processCodeBaseData = function(data) {
        ...
        if(data.content && data.content.certificate_list[0]){
            ...
            var ordering = 0;
            for(var i = eList.length-1; i >= 0 ; i--){
                html += '<div class="infopledu">  <div class="mt-title"><div class="metil mt10">证书' + (ordering+1) + '</div><div class="mt-edit"><i></i>编辑</div></div>  <div class="infopl" data-id="' + eList[i].id + '"> <table width="100%" border="0" cellspacing="0" cellpadding="0"> <tbody><tr> <td width="76" class="col999">证书名称</td> <td class="mt_base" id="mt_certificateName">' + eList[i].certificateName + '</td> </tr> <tr> <td width="76" class="col999">获得时间</td> <td class="mt_base" id="mt_getDate">' + eList[i].getDate + '</td> </tr> <tr> <td width="76" class="col999">证书描述</td> <td class="mt_base" id="mt_certificateDes">' + eList[i].certificateDes + '</td> </tr> <tr> <td width="76" class="col999">颁发机构</td> <td class="mt_base" id="mt_issuing">' + eList[i].issuing + '</td> </tr> </tbody> </table> </div>';
...
KISSY.add('jmPopTraining', function(S, Node, Base, IO) {
    ...
    var processCodeBaseData = function(data) {
        ...
        if(data.content && data.content.trainingexperience_list[0]){
            ...
            var ordering = 0;
            for(var i = eList.length-1; i >= 0 ; i--){
                html += '<div class="infopledu">  <div class="mt-title"><div class="metil mt10">培训经历书' + (ordering+1) + '</div><div class="mt-edit"><i></i>编辑</div></div>  <div class="infopl" data-id="' + eList[i].id + '"> <table width="100%" border="0" cellspacing="0" cellpadding="0"> <tbody><tr> <td width="76" class="col999">培训名称</td> <td class="mt_base" id="mt_trainingName">' + eList[i].trainingName + '</td> </tr> <tr> <td width="76" class="col999">培训内容</td> <td class="mt_base" id="mt_trainingDes">' + eList[i].trainingDes + '</td> </tr> <tr> <td width="76" class="col999">培训机构</td> <td class="mt_base" id="mt_trainingCompany">' + eList[i].trainingCompany + '</td> </tr> <tr> <td width="76" class="col999">培训地点</td> <td class="mt_base" id="mt_trainingPlace">' + eList[i].trainingPlace + '</td> </tr> <tr> <td width="76" class="col999">开始时间</td> <td class="mt_base" id="mt_startDate">' + eList[i].startDate + '</td> </tr> <tr> <td width="76" class="col999">结束时间</td> <td class="mt_base" id="mt_endDate">' + eList[i].endDate + '</td> </tr> <tr> <td width="76" class="col999">获得证书</td> <td class="mt_base" id="mt_certificateName">' + eList[i].certificateName + '</td> </tr> </tbody> </table> </div>';
